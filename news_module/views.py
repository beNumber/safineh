...
def article_list(request):
    ...
    return render(request, "news_module/article_list.html", context)
...
def article_detail(request, slug):
    ...
    return render(request, "news_module/article_detail.html", context)
...
def article_create(request):
    ...
    if not _is_staff(request.user):
        ...
        return redirect("news_module:article_list")
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("news_module:article_detail", slug=article.slug)
    else:
        form = ArticleForm()

    context = {"form": form, "title": "ایجاد خبر جدید"}
    return render(request, "news_module/article_form.html", context)
...
def article_delete(request, slug):
    ...
    return render(request, "news_module/article_confirm_delete.html", context)
...
def category_list(request):
    ...
    return render(request, "news_module/category_list.html", context)
...
def category_create(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("news_module:category_list")
    else:
        form = CategoryForm()

    context = {"form": form, "title": "ایجاد دسته‌بندی"}
    return render(request, "news_module/category_form.html", context)
...
def category_delete(request, pk):
    ...
    return render(request, "news_module/category_confirm_delete.html", context)
...
def tag_create(request):
    ...
    return render(request, "news_module/tag_form.html", context)
...
def tag_delete(request, pk):
    ...
    context = {"tag": tag}
    return render(request, "news_module/tag_confirm_delete.html", context)
