...
urlpatterns = [
    ...
    path("curriculum/", views.curriculum_manage, name="curriculum_manage"),
    path("curriculum/<str:kind>/create/", views.curriculum_entity_create, name="curriculum_entity_create"),
    path("curriculum/<str:kind>/<int:pk>/edit/", views.curriculum_entity_edit, name="curriculum_entity_edit"),
    path("curriculum/<str:kind>/<int:pk>/delete/", views.curriculum_entity_delete, name="curriculum_entity_delete"),
